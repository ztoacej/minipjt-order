...
- 재고 데이터 정합성 보장
- 재고 음수 발생 방지
- 9-1. 재고 1인 상품에 대한 주문 2번 시도 결과 테스트 이미지
  ![재고 차감 결과](./test-images/orders-test/16-3-worktry2-stock1-create-first-order-pm.png)
  ![재고 차감 결과](./test-images/orders-test/16-4-worktry2-stock0-create-second-order-pm.png)
---
